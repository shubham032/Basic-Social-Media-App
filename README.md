...
- 🗂️ **Categories**: Posts can be categorized into predefined categories.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/shubham032/Basic-Social-Media-App.git
   cd Basic-Social-Media-App
